...
`Brazzer\Admin\Widgets\Box` used to generate box components:
...
`Brazzer\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Brazzer\Admin\Widgets\Collapse;
...
`Brazzer\Admin\Widgets\Form` class is used to quickly build a form:
...
`Brazzer\Admin\Widgets\InfoBox` class is used to generate the information presentation block:
...
`Brazzer\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Brazzer\Admin\Widgets\Tab;
...
`Brazzer\Admin\Widgets\Table` class is used to generate tables:

```php
use Brazzer\Admin\Widgets\Table;

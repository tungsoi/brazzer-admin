...
namespace Auth\Database\CustomModel\Relations;
...
class Builder{
    ...
    public function orWhere($column, $operator = null, $value = null){
        [
            $value,
            $operator
        ] = $this->query->prepareValueAndOperator($value, $operator, func_num_args() === 2);
        ...
        foreach($relations as $name => $constraints){
            ...
            if(is_numeric($name)){
                ...
                [
                    $name,
                    $constraints
                ] = Str::contains($name, ':') ? $this->createSelectWithConstraint($name) : [
                    $name,
                    function(){
                        //
                    }

...
namespace Brazzer\Admin\Console;
...
class InstallCommand extends Command
{
    ...
    public function initDatabase()
    {
        ...
        if ($userModel::count() == 0) {
            $this->call('db:seed', ['--class' => \Brazzer\Admin\Auth\Database\AdminTablesSeeder::class]);
        }
        $this->call('db:seed', ['--class' => \Brazzer\Admin\Auth\Database\Seeders\MenuTableSeeder::class]);
        $this->call('db:seed', ['--class' => \Brazzer\Admin\Auth\Database\Seeders\RoleTableSeeder::class]);
    }

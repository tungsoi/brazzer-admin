...
namespace Brazzer\Admin\Controllers\Form;
...
class ConfigForm extends Form{
    ...
    public function getConfigValues($is_edit = false){
        ...
        $this->builder()->fields()->each(function(Field $field) use ($values, $is_edit){
            if($field instanceof Field\MultipleImage or $field instanceof Field\MultipleFile){
    ...
    public function configUpdate(){
        ...
        DB::transaction(function(){
            ...
            if($updates){
                foreach($updates as $key => $val){
                    ...
                    $this->model->updateOrCreate(['name' => $name], ['value' => $val]);
                }
            }
        });
        ...
        return redirect(route('admin.siteconfig.index'));
    }
}
...
class MenuController extends Controller{
    ...
    public function index(Content $content){
        return $content->header(trans('admin.menu'))->description(trans('admin.list'))->row(function(Row $row){
            ...
            $row->column(6, function(Column $column){
                ...
                $form->select('type_id', trans('admin.position'))->options([
                    1 => 'Left',
                    2 => 'Right',
                    3 => 'Top',
                ]);
                ...
                $form->switch('is_header', trans('admin.header'))->states($states)->default(0);
    ...
    public function edit($id, Content $content){
        return $content->header(trans('admin.menu'))->description(trans('admin.edit'))->row($this->form()->edit($id));
    }

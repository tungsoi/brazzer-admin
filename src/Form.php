...
use Brazzer\Admin\Exception\Handler;
use Brazzer\Admin\Form\Builder;
use Brazzer\Admin\Form\Column;
use Brazzer\Admin\Form\Field;
use Brazzer\Admin\Form\HasHooks;
use Brazzer\Admin\Form\Layout\Layout;
use Brazzer\Admin\Form\Row;
use Brazzer\Admin\Form\Tab;
use Closure;
 ...
 * @method Field\Crop           crop($column, $label = '')
 * @method Field\Slug           slug($column, $label = '')
 */
class Form implements Renderable{
    ...
    public static $availableFields = [
        ...
        'crop'           => Field\Crop::class,
        'slug'           => Field\Slug::class,
    ];
    ...
    */
    ...
    protected function getFieldByColumn($column){
        return $this->builder->fields()->first(function(Field $field) use ($column){
    ...
    public function getRelations(): array
    {
        ...
        foreach(Arr::flatten($columns) as $column){
            if(Str::contains($column, '.')){
                ...
                if(method_exists($this->model, $relation) && $this->model->$relation() instanceof Relations\Relation){
                    $relations[] = $relation;
                }
     ...
     * @param Closure $callback
     *
     * @return \Brazzer\Admin\Form\Footer
     */
    ...
    public function footerHtml($html){
        $this->builder()->getFooter()->footerHtml($html);

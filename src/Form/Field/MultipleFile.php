...
class MultipleFile extends File{
    ...
    protected static $css = [
        '/brazzer-admin/bootstrap-fileinput/css/fileinput.min.css?v=4.5.2',
    ];
     ...
     */
    protected static $js = [
        '/brazzer-admin/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js',
        '/brazzer-admin/bootstrap-fileinput/js/fileinput.min.js?v=4.5.2',
        '/brazzer-admin/bootstrap-fileinput/js/plugins/sortable.min.js?v=4.5.2',
    ];
...
EOT;
    ...
    //hongnn
    public function mine($list_mine = []){
        $list_mine_arr = [];
        if($list_mine){
            foreach ($list_mine as $mine){
                if(in_array($mine, ['jpg', 'jpeg', 'png', 'gif'])){
                    $list_mine_arr[] = 'image/'.$mine;
                }elseif(in_array($mine, ['pdf'])){
                    $list_mine_arr[] = 'application/pdf';
                }elseif(in_array($mine, ['excel', 'csv'])){
                    $list_mine_arr[] = 'application/vnd.ms-excel';
                    $list_mine_arr[] = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';
                    $list_mine_arr[] = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel';
                }else{
                    $list_mine_arr[] = '.'.$mine;
                }
            }
        ...
        if($list_mine_arr){
            $this->attribute('accept', implode(',', $list_mine_arr));
        }
    }
}

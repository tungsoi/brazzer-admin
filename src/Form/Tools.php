...
class Tools implements Renderable{
    ...
    public function enableDelete(bool $enable = true){
        if($enable){
            array_push($this->tools, 'delete');
        }elseif(!in_array('delete', $this->tools)){
            array_delete($this->tools, 'delete');
    ...
    protected function renderList(){
        ...
        return <<<EOT
<div class="btn-group btn-{$form_style} pull-right" style="margin-right: 5px">
    <a href="{$this->getListPath()}" class="btn btn-{$form_style} btn-default" title="$text"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;$text</span></a>
</div>
EOT;
    }
...
<div class="btn-group pull-right" style="margin-right: 5px">
    <a href="{$this->getViewPath()}" class="btn btn-{$form_style} btn-primary" title="{$view}">
...
<div class="btn-group btn-group-xs pull-right" style="margin-right: 5px">
    <a href="javascript:void(0);" class="btn btn-{$form_style} btn-danger {$class}-delete" title="{$trans['delete']}">

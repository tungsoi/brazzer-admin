...
<div class="dropdown pull-right column-selector" style="margin-right: 10px">
    <button type="button" class="btn btn-{$form_style} btn-instagram dropdown-toggle" data-toggle="dropdown">
    ...
    <ul class="dropdown-menu" role="menu" style="padding: 10px;">
        ...
        <li class="divider"></li>
        <li class="text-right">
            <button class="btn btn-{$form_style} btn-default pull-left column-select-all">{$btns['all']}</button>&nbsp;&nbsp;
            <button class="btn btn-{$form_style} btn-primary column-select-submit">{$btns['submit']}</button>
        </li>
    </ul>
</div>
EOT;

...
class AzureSocialiteProvider extends AbstractProvider implements ProviderInterface{
    ...
    public function user(){
        ...
        return $user->setToken($token)->setRefreshToken(Arr::get($response, 'refresh_token'));
    }

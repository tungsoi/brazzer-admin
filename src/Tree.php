...
use Closure;
use Brazzer\Admin\Tree\Concerns\HasElementNames;
use Brazzer\Admin\Tree\Concerns\HasFilter;
use Brazzer\Admin\Tree\Model;
use Brazzer\Admin\Tree\Tools;
use Illuminate\Contracts\Support\Renderable;
use Illuminate\Database\Eloquent\Model as Eloquent;

class Tree implements Renderable{
    use HasElementNames, HasFilter;
    /**
     * @var array
     */
    protected $items = [];
     ...
     */
    public function __construct(Eloquent $model = null, \Closure $callback = null){
...
SCRIPT;
    ...
    public function getItems(){
        $query = $this->model()->eloquent();
        $conditions = $this->filter->conditions();
        $query->list_query($conditions);
        return $query->withQuery($this->queryCallback)->toTree();
    }
    ...
    public function render(){
        ...
        view()->share([
            'path'           => $this->path,
            'keyName'        => $this->model()->eloquent()->getKeyName(),
